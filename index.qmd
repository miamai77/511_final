...
Next steps include:
-   Removing outliers from religious adherence data
-   Gathering state- and metro-level survey data from PRRI and Pew, with questions relating to RWA
-   Modeling state-level RWA values from religion and socioeconomic data, to find factors most likely influencing RWA
-   Predicting county-level RWA values based on this model
# Results
...
Clear summary adequatelydescribing the results and putting them in context. Discussion of further questions and ways to continue investigation.
