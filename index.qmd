...
```{r, message=F, warning=F, echo=F, include=F} # Trying to add something that will prevent the installation process from being printed. Maybe just list whats needed? 
...
# I like that you are explaining the whole process and the reasons youre doing something specifically
...
```
# Will you map all the religions youre looking at? Is there a way to make these maps on like, a selector, where you can select which map so its not multiple maps but just one? 
